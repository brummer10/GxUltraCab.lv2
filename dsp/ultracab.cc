// generated from file './/ultracab.dsp' by dsp2cc:
...
inline void Dsp::clear_state_f()
{
	...
	for (int i=0; i<8; i++) fRec11[i] = 0;
	for (int i=0; i<4; i++) fRec10[i] = 0;
	for (int i=0; i<6; i++) fRec9[i] = 0;
}
...
#define fslider5 (*fslider5_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = ((fConst0 * (fConst12 + (fConst10 * fRec0[0]))) - 1.70858097381046e-12);
		double fTemp2 = (1.81767568680935e-11 + (fConst0 * (fConst16 + ((fConst15 * fRec0[0]) + (fRec1[0] * (2.03577641146236e-14 + (fConst0 * (fConst14 + (fConst13 * fRec0[0])))))))));
		double fTemp3 = (9.08837843404676e-11 + (fConst0 * (fConst22 + ((fConst20 * fRec0[0]) + (fRec1[0] * (6.10732923438708e-14 + (fConst0 * (fConst4 + (fConst18 * fRec0[0])))))))));
		double fTemp4 = (1.81767568680935e-10 + (fConst0 * (fConst30 + ((fConst28 * fRec0[0]) + (fRec1[0] * (4.07155282292472e-14 + (fConst0 * (fConst26 + (fConst24 * fRec0[0])))))))));
		double fTemp5 = (1.81767568680935e-10 + (fConst0 * (fConst34 + ((fConst33 * fRec0[0]) + (fRec1[0] * ((fConst0 * (fConst32 + (fConst31 * fRec0[0]))) - 4.07155282292472e-14))))));
		double fTemp6 = (9.08837843404676e-11 + (fConst0 * (fConst37 + ((fConst36 * fRec0[0]) + (fRec1[0] * ((fConst0 * (fConst14 + (fConst35 * fRec0[0]))) - 6.10732923438708e-14))))));
		fRec3[0] = (fSlow2 + (0.993 * fRec3[1]));
		fRec4[0] = (fSlow3 + (0.993 * fRec4[1]));
		double fTemp7 = (7.64281973309539e-07 + (fConst0 * (fConst45 + ((fConst43 * fRec3[0]) + (fRec4[0] * (8.71281449572875e-09 + (fConst0 * (fConst41 + (fConst39 * fRec3[0])))))))));
		double fTemp8 = (1.68220418103441e-15 + (3.17397015289512e-14 * fRec3[0]));
		double fTemp9 = (1.58698507644756e-11 * fRec3[0]);
		double fTemp10 = (8.41102090517206e-13 + (fTemp9 + (fConst0 * (fRec4[0] * (0 - fTemp8)))));
		double fTemp11 = (7.64281973309539e-07 + (fConst0 * (fConst49 + ((fConst48 * fRec3[0]) + (fRec4[0] * ((fConst0 * (fConst47 + (fConst46 * fRec3[0]))) - 8.71281449572875e-09))))));
		double fTemp12 = (2.29284591992862e-06 + (fConst0 * (((fConst54 * fRec3[0]) + (fRec4[0] * ((fConst0 * (fConst53 + (fConst51 * fRec3[0]))) - 8.71281449572875e-09))) - fConst45)));
		double fTemp13 = (2.29284591992862e-06 + (fConst0 * (fConst58 + ((fConst57 * fRec3[0]) + (fRec4[0] * (8.71281449572875e-09 + (fConst0 * (fConst56 + (fConst55 * fRec3[0])))))))));
		fRec6[0] = (fSlow4 + (0.993 * fRec6[1]));
		fRec7[0] = (fSlow5 + (0.993 * fRec7[1]));
		double fTemp14 = (fConst68 + ((fConst66 * fRec6[0]) + (fRec7[0] * (5.28918916148995e-25 + ((fConst64 * fRec6[0]) + (fConst0 * (fConst63 + (fRec7[0] * (fConst62 + (fConst60 * fRec6[0]))))))))));
		double fTemp15 = (1.09432242004542e-13 * fRec7[0]);
		double fTemp16 = ((fConst0 * (fConst70 + fTemp15)) - 5.47161210022711e-11);
		double fTemp17 = (fConst76 + ((fConst75 * fRec6[0]) + (fRec7[0] * (5.28918916148995e-25 + ((fConst74 * fRec6[0]) + (fConst0 * (fConst73 + (fRec7[0] * (fConst72 + (fConst71 * fRec6[0]))))))))));
		double fTemp18 = (fConst86 + ((fConst84 * fRec6[0]) + (fRec7[0] * (3.70243241304296e-24 + ((fConst82 * fRec6[0]) + (fConst0 * (fConst81 + (fRec7[0] * (fConst80 + (fConst78 * fRec6[0]))))))))));
		double fTemp19 = (fConst96 + ((fConst94 * fRec6[0]) + (fRec7[0] * (1.11072972391289e-23 + ((fConst92 * fRec6[0]) + (fConst0 * (fConst91 + (fRec7[0] * (fConst90 + (fConst88 * fRec6[0]))))))))));
		double fTemp20 = (fConst106 + ((fConst104 * fRec6[0]) + (fRec7[0] * (1.85121620652148e-23 + ((fConst102 * fRec6[0]) + (fConst0 * (fConst101 + (fRec7[0] * (fConst100 + (fConst98 * fRec6[0]))))))))));
		double fTemp21 = (fConst112 + ((fConst111 * fRec6[0]) + (fRec7[0] * (1.85121620652148e-23 + ((fConst110 * fRec6[0]) + (fConst0 * (fConst109 + (fRec7[0] * (fConst108 + (fConst107 * fRec6[0]))))))))));
		double fTemp22 = (fConst118 + ((fConst117 * fRec6[0]) + (fRec7[0] * (1.11072972391289e-23 + ((fConst116 * fRec6[0]) + (fConst0 * (fConst115 + (fRec7[0] * (fConst114 + (fConst113 * fRec6[0]))))))))));
		double fTemp23 = (fConst124 + ((fConst123 * fRec6[0]) + (fRec7[0] * (3.70243241304296e-24 + ((fConst122 * fRec6[0]) + (fConst0 * (fConst121 + (fRec7[0] * (fConst120 + (fConst119 * fRec6[0]))))))))));
		fRec8[0] = ((double)input0[i] - ((((((((fRec8[1] * fTemp23) + (fRec8[2] * fTemp22)) + (fRec8[3] * fTemp21)) + (fRec8[4] * fTemp20)) + (fRec8[5] * fTemp19)) + (fRec8[6] * fTemp18)) + (fRec8[7] * fTemp17)) / fTemp14));
		double fTemp24 = (3.28296726013626e-13 * fRec7[0]);
		double fTemp25 = ((fConst0 * (fConst125 + fTemp24)) - 2.73580605011355e-10);
		double fTemp26 = ((fConst0 * (fConst127 + fTemp15)) - 4.9244508902044e-10);
		double fTemp27 = (0 - (5.47161210022711e-13 * fRec7[0]));
		double fTemp28 = ((fConst0 * (fConst128 + fTemp27)) - 2.73580605011355e-10);
		double fTemp29 = (2.73580605011355e-10 + (fConst0 * (fConst129 + fTemp27)));
		double fTemp30 = (4.9244508902044e-10 + (fConst0 * (fConst130 + fTemp15)));
		double fTemp31 = (2.73580605011355e-10 + (fConst0 * (fConst131 + fTemp24)));
		double fTemp32 = (5.47161210022711e-11 + (fConst0 * (fConst132 + fTemp15)));
		fRec5[0] = ((fConst0 * (((((((((fRec8[0] * fTemp32) + (fRec8[1] * fTemp31)) + (fRec8[2] * fTemp30)) + (fRec8[3] * fTemp29)) + (fRec8[4] * fTemp28)) + (fRec8[5] * fTemp26)) + (fRec8[6] * fTemp25)) + (fRec8[7] * fTemp16)) / fTemp14)) - ((((fRec5[1] * fTemp13) + (fRec5[2] * fTemp12)) + (fRec5[3] * fTemp11)) / fTemp7));
		double fTemp33 = (8.41102090517206e-13 + fTemp9);
		double fTemp34 = (5.04661254310323e-15 + (9.52191045868535e-14 * fRec3[0]));
		double fTemp35 = ((fConst0 * (fRec4[0] * fTemp34)) - fTemp33);
		double fTemp36 = ((fConst0 * (fRec4[0] * (0 - fTemp34))) - fTemp33);
		double fTemp37 = (8.41102090517206e-13 + (fTemp9 + (fConst0 * (fRec4[0] * fTemp8))));
		fRec2[0] = (unicab_p2clip((fConst133 * (((((fRec5[0] * fTemp37) + (fRec5[1] * fTemp36)) + (fRec5[2] * fTemp35)) + (fRec5[3] * fTemp10)) / fTemp7))) - ((((((fRec2[1] * fTemp6) + (fRec2[2] * fTemp5)) + (fRec2[3] * fTemp4)) + (fRec2[4] * fTemp3)) + (fRec2[5] * fTemp2)) / fTemp0));
		double fTemp38 = ((fConst0 * (fConst137 + (fConst135 * fRec0[0]))) - 5.12574292143137e-12);
		double fTemp39 = ((fConst0 * (fConst141 + (fConst139 * fRec0[0]))) - 3.41716194762091e-12);
		double fTemp40 = (3.41716194762091e-12 + (fConst0 * (fConst143 + (fConst142 * fRec0[0]))));
		double fTemp41 = (5.12574292143137e-12 + (fConst0 * (fConst145 + (fConst144 * fRec0[0]))));
		double fTemp42 = (1.70858097381046e-12 + (fConst0 * (fConst147 + (fConst146 * fRec0[0]))));
		output0[i] = (FAUSTFLOAT)unicab_p3clip((fConst0 * (((((((fRec2[0] * fTemp42) + (fRec2[1] * fTemp41)) + (fRec2[2] * fTemp40)) + (fRec2[3] * fTemp39)) + (fRec2[4] * fTemp38)) + (fRec2[5] * fTemp1)) / fTemp0)));
		fRec11[0] = ((double)input1[i] - ((((((((fRec11[1] * fTemp23) + (fRec11[2] * fTemp22)) + (fRec11[3] * fTemp21)) + (fRec11[4] * fTemp20)) + (fRec11[5] * fTemp19)) + (fRec11[6] * fTemp18)) + (fRec11[7] * fTemp17)) / fTemp14));
		fRec10[0] = ((fConst0 * ((((((fRec11[3] * fTemp29) + ((fRec11[2] * fTemp30) + ((fRec11[1] * fTemp31) + ((fRec11[4] * fTemp28) + (fRec11[0] * fTemp32))))) + (fRec11[5] * fTemp26)) + (fRec11[6] * fTemp25)) + (fRec11[7] * fTemp16)) / fTemp14)) - ((((fRec10[1] * fTemp13) + (fRec10[2] * fTemp12)) + (fRec10[3] * fTemp11)) / fTemp7));
		fRec9[0] = (unicab_p2clip((fConst133 * (((((fTemp37 * fRec10[0]) + (fRec10[1] * fTemp36)) + (fRec10[2] * fTemp35)) + (fRec10[3] * fTemp10)) / fTemp7))) - ((((((fRec9[1] * fTemp6) + (fRec9[2] * fTemp5)) + (fRec9[3] * fTemp4)) + (fRec9[4] * fTemp3)) + (fRec9[5] * fTemp2)) / fTemp0));
		output1[i] = (FAUSTFLOAT)unicab_p3clip((fConst0 * (((((((fRec9[0] * fTemp42) + (fRec9[1] * fTemp41)) + (fRec9[2] * fTemp40)) + (fRec9[3] * fTemp39)) + (fRec9[4] * fTemp38)) + (fRec9[5] * fTemp1)) / fTemp0)));
		// post processing
		for (int i=5; i>0; i--) fRec9[i] = fRec9[i-1];
		for (int i=3; i>0; i--) fRec10[i] = fRec10[i-1];
		for (int i=7; i>0; i--) fRec11[i] = fRec11[i-1];
